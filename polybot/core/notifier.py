...
# Best-effort emoji marker per message-type, purely cosmetic.
_EMOJI_BY_PREFIX: list[tuple[str, str]] = [
    ...
    ("Location classifier unavailable", "\u26a0\ufe0f"),
    ("Location protection feed summary skipped", "\u26a0\ufe0f"),
    ("Location protection polling cycle failed", "\u26a0\ufe0f"),
...
def render_telegram_message(message: str, fields: dict[str, Any]) -> str:
    """Build outgoing Telegram text from a bare message plus fields."""
...
__all__ = ["Notifier", "TelegramNotifier", "render_telegram_message"]
