...
from .executor import LivePosition, TradingAdapter
...
def default_operator_dir(config: IranBotConfig) -> Path:
...
class OperatorGate:
    def __init__(self, config_path: Path, config: IranBotConfig, *, operator_dir: Path | None = None, position_id: str | None = None) -> None:
    ...
    def check(self, decision: Decision, *, live_requested: bool) -> GateResult:
    ...
    def log_block_once(self, result: GateResult, decision: Decision) -> bool:
